...
const Footer = () => (
  <footer className="footer">
    <div className="footer-content">
      <span>© {new Date().getFullYear()} Proyecto ICU Sevilla</span>
      <a
        href="https://github.com/migueBarrera/uhi-sevilla-ml"
        target="_blank"
        rel="noopener noreferrer"
        className="footer-link"
      >
        Código fuente en GitHub
        <svg height="20" width="20" viewBox="0 0 16 16" fill="currentColor" style={{marginLeft: 8}} aria-hidden="true">
